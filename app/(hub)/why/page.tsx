...
export default function WhyPage() {
  return (
    <div className="bg-hub-background">
      ...
      <section className="relative pt-20 pb-12 md:pt-28 md:pb-16">
        <div className="mx-auto max-w-3xl px-6 lg:px-12">
          ...
          <motion.p
            ...
            className="mt-6 text-xl md:text-2xl text-hub-muted-foreground leading-relaxed"
          >
      ...
      <section className="py-12 md:py-16 bg-hub-muted/40">
        <div className="mx-auto max-w-3xl px-6 lg:px-12">
          <AnimatedSection>
          ...
          <div className="mt-8 space-y-5 text-lg md:text-xl text-hub-muted-foreground leading-relaxed">
          ...
          <AnimatedSection delay={0.3} className="mt-12">
            <div className="mx-auto max-w-md">
              <Image
                ...
                alt="Nicole and Phillip Shepard, founders of All Things Agents"
                width={1400}
                height={900}
                className="w-full h-auto"
              />
              <p className="mt-3 text-center text-base text-hub-muted-foreground">
                Phillip &amp; Nicole Shepard — Founders
              </p>
            </div>
          </AnimatedSection>
        </div>
      ...
      {/* Section 4 — From One Agent to Another */}
      <section className="py-12 md:py-16 bg-hub-muted/40">
        <div className="mx-auto max-w-3xl px-6 lg:px-12">
          <AnimatedSection>
            <h2 className="font-display text-4xl md:text-5xl font-bold text-hub-foreground tracking-tight leading-tight">
          ...
          <div className="space-y-8 text-center">
            {[
              ...
              <AnimatedSection key={index} delay={index * 0.15}>
                <p className="font-display text-3xl md:text-4xl lg:text-5xl font-semibold text-hub-foreground">
                  {statement}
                </p>
              </AnimatedSection>
            ))}
