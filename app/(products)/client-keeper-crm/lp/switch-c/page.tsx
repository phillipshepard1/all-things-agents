...
import { SwitchHeroSimplicity } from "@/components/sections/landing/switch-hero-simplicity";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${baseUrl}/client-keeper-crm/lp/switch-c`,
  },
  openGraph: {
    title: "Switch to a Simpler CRM | Client Keeper for Real Estate",
    description:
      "Tired of complex, overpriced CRMs? Client Keeper is the $19/month real estate CRM that takes 20 minutes to set up. No training required.",
    url: `${baseUrl}/client-keeper-crm/lp/switch-c`,
...
export default function SwitchCLandingPage() {
  return (
    <>
      <JsonLd data={generateFAQSchema(faqs)} />

      <SwitchHeroSimplicity />
