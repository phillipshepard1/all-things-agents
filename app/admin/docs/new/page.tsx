...
export default function NewDocPage() {
  ...
  const handleGuideImport = (data: GuideImportResult) => {
    ...
    // Set the editor content - using setTimeout to allow state updates to settle
    setTimeout(() => {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            Create a new support documentation page
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                placeholder="How to Add a New Contact"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none"
                placeholder="Step-by-step guide to adding contacts"
              />
            </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, status: 'scheduled' }))}
                className="text-purple-600 focus:ring-purple-500"
              />
