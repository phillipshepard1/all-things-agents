...
import { ArrowRight, Check, HelpCircle, X, StickyNote, Table2, Users, Mail, Calendar, Phone, Clock, MessageSquare } from "lucide-react";
...
export function HeroStrikethroughSplitReveal() {
