...
import { Monitor, Smartphone, Mic, BarChart3, Users, Zap, FileText, RefreshCw } from "lucide-react";
...
export function MobileDesktopComparison() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 font-[family-name:var(--font-outfit)]">
            Start Anywhere,{" "}
            <span className="text-gradient">Continue Everywhere</span>
          </h2>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Your work flows seamlessly between mobile and desktop.
            Each platform is optimized for what it does best.
          </p>
        </div>
            ...
            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Capture & Update</p>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/20">
                <div className="flex items-center gap-2 text-sm text-white/70">
                  <span>Best for:</span>
                  <span className="font-medium text-white">Field work, quick notes, voice memos</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-white p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
            ...
            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Desktop</h3>
                  <p className="text-sm text-gray-500">Analyze & Manage</p>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <span>Best for:</span>
                  <span className="font-medium text-gray-900">Reports, bulk edits, deep analysis</span>
                </div>
              </div>
            </div>
          </div>
