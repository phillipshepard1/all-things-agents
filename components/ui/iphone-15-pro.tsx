...
export function Iphone15Pro({
  ...
  const hasContent = hasVideo || hasImage || hasChildren;
  ...
  return (
    ...
    >
      ...
      >
        <g mask={hasContent ? "url(#screenPunch15Pro)" : undefined}>
          {/* Outer frame */}
          <path
        ...
        <path
          ...
          mask={hasContent ? "url(#screenPunch15Pro)" : undefined}
        />
        ...
        <path
          ...
          className="fill-[#2a2a3a] dark:fill-[#2a2a3a]"
        />

        <defs>
          <mask id="screenPunch15Pro" maskUnits="userSpaceOnUse">
